    ...
    <Routes>
      <Route path="/" element={<RouteLayout />}>
        ...
        <Route element={<RequireAuth allowedRoles={[ROLES.ADMIN]} />}>
          ...
          <Route path="admin/site-management/site/:id" element={<SiteDetail />} />
          <Route path="admin/add-gateway" element={<AddGateway />} />
          <Route path="admin/site-management/gateway/:id" element={<ViewSiteGatewayDetail />} />
          <Route path="admin/site-management/branch_manager/:id" element={<ViewSiteBranchManagerDetail />} />
          <Route path="admin/site-management/node/:id" element={<ViewSiteNodeDetail />} />
          <Route path="admin/user-management/view-user/:id" element={<ViewUser />} />
          <Route path="admin/device-management" element={<DeviceManagement />} />
          <Route path="admin/device-management/gateway/:id" element={<ViewGatewayDM />} />
          <Route path="/admin/device-management/node/:id" element={<ViewNodeDM />} />
          <Route path="/admin/device-management/branch-manager/:id" element={<ViewBranchManagerDM />} />
        </Route>
